...
$quer2="SELECT DISTINCT id,name FROM community where  parent_id=0  "; 
...
$quer="SELECT DISTINCT id,name FROM community where parent_id = $cat "; 
...
$quer3="SELECT DISTINCT id,name FROM community where  parent_id = $cat3  "; 
